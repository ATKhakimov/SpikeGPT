...
> Статус: legacy-отчет по первой модели `v0_taiga_100m`. Актуальная карта проекта, v1/SFT-эксперименты и ссылки на Hugging Face вынесены в [`README.md`](README.md), а статья и технические заметки - в [`ARTICLE/`](ARTICLE/).
